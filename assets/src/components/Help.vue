<template>
  <div class="p-4" style="max-width: 600px;">
    <div class="pb-4">
      ...
      <p>
        社内のコミュニケーション活性化を目指して、社員同士の食事会の料金の一部を補助する制度です。
      </p>
    </div>
    ...
    <div class="pb-4">
      ...
      <dl>
        ...
        <dt><badge-night/></dt><dd>3240円(税込)/名[毎月先着8組]</dd>
      </dl>
    </div>
    ...
    <div class="pb-4">
      <h2 class="h6 text-black-50 font-weight-bold">■ 注意点</h2>
      <ul>
        <li>実施日の前日までに等サイトで申請してください</li>
        <li>実施日には必ず申請したメンバーで開催してください</li>
        <li>事後申請はできません</li>
        <li>来月以降の登録はできません</li>
      </ul>
    </div>
